...
fn ender() -> Endereco {
    Endereco { x_lgr: "RUA A".into(), nro: "10".into(), x_cpl: None, x_bairro: "CENTRO".into(),
...
fn sample() -> BpeBuildData {
    BpeBuildData {
        ...
        ide: IdeBpe {
            c_uf: "35".into(), tp_amb: "2".into(), serie: 1, n_bp: 1, modal: "1".into(),
            dh_emi: "2026-06-06T10:00:00-03:00".parse().unwrap(), tp_emis: "1".into(),
            ver_proc: None, tp_bpe: "0".into(), ind_pres: "1".into(),
            uf_ini: "SP".into(), c_mun_ini: "3550308".into(), uf_fim: "SP".into(), c_mun_fim: "3509502".into(),
            dh_cont: None, x_just: None,
        },
        emit: BpeEmit {
            cnpj: "12345678000190".into(), ie: "111111111111".into(), iest: None,
            x_nome: "VIACAO TESTE".into(), x_fant: None, im: None,
            crt: "3".into(), ender_emit: ender(), tar: Some("12345".into()),
        },
        comp: None,
        inf_valor: InfValorBpe { v_bp: "100.00".into(), v_desconto: "0.00".into(), v_pgto: "100.00".into(), v_troco: "0.00".into(), comp: vec![CompBpe { tp_comp: "01".into(), v_comp: "100.00".into() }] },
        inf_viagem: vec![InfViagem {
            c_percurso: "SP".into(), x_percurso: "SAO PAULO-CAMPINAS".into(), tp_viagem: "00".into(),
            tp_serv: "1".into(), tp_acomodacao: "2".into(), tp_trecho: Some("1".into()),
            dh_viagem: "2026-06-07T08:00:00-03:00".into(), prefixo: None, poltrona: Some("12".into()), plataforma: None,
        }],
        inf_passagem: InfPassagem {
            c_loc_orig: "3550308".into(), x_loc_orig: "SAO PAULO".into(),
            c_loc_dest: "3509502".into(), x_loc_dest: "CAMPINAS".into(),
            dh_emb: "2026-06-07T08:00:00-03:00".into(), dh_validade: "2026-06-08T08:00:00-03:00".into(), passageiro: None,
        },
        imp: BpeImp { icms: Icms::IcmsSn { ind_sn: "1".into() }, v_tot_trib: None },
        pag: vec![Pagamento { t_pag: "01".into(), x_pag: None, v_pag: "100.00".into() }],
        aut_xml: vec![],
        inf_resp_tec: None,
    }
}
